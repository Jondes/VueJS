...
<ValidationObserver ref="observer">
    <b-form v-slot="{ validate }" @submit.prevent="validate().then(handleSubmit)">
      <ValidationProvider rules="required" name="Name">
        <b-form-group v-slot ="{ valid, errors }" label="Name">
            <b-form-input
              type="text"
              v-model="user.name"
      ...
      <ValidationProvider name="City" rules="required">
        <b-form-group v-slot="{ valid, errors }" label="City:">
          <b-form-select 
            :state="errors[0] ? false : (valid ? true : null)" 
            v-model="user.city">
      ...
      <ValidationProvider name="Hobbies" rules="required|length:1">
        <b-form-group v-slot="{ valid, errors }">
